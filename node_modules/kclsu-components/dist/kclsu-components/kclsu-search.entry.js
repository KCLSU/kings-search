...
const kclsuSearchCss = globalstylesCss + ".kclsu_search{font-size:25px!important;border:2px solid teal!important;color:teal;margin:1.5em 0!important;max-width:800px;border-width:2px!important;border-style:solid;border-color:rgb(97, 190, 177)!important;border-image:initial;padding:0.6em!important;width:360px!important}@media only screen and (max-width: 480px){.kclsu_search{font-size:25px!important;border:2px solid teal!important;color:teal;margin:1.5em 0!important;padding:0.3em!important;width:280px!important}}.kclsu_search:focus{border-color:rgb(97, 190, 177)!important;outline:rgb(97, 190, 177) auto 5px!important}.hide{display:none}.transition{transition:top 3s;transition-delay:2s}.noresults{text-align:center!important;color:#502865!important;font-weight:bold;margin:1em!important;font-size:18px!important;display:block!important;animation:slide-in-right 0.5s cubic-bezier(0.250, 0.460, 0.450, 0.940) both}@-webkit-keyframes slide-in-right{0%{-webkit-transform:translateX(1000px);transform:translateX(1000px);opacity:0}100%{-webkit-transform:translateX(0);transform:translateX(0);opacity:1}}@keyframes slide-in-right{0%{-webkit-transform:translateX(1000px);transform:translateX(1000px);opacity:0}100%{-webkit-transform:translateX(0);transform:translateX(0);opacity:1}}";

const KclsuSearch = class {
    constructor(hostRef) {
    ...
    inputHandler(e) {
        ...
        if (this.attr)
            this.searchByAttr(searchTerm.toLowerCase());
        else
            this.searchBySelector(searchTerm.toLowerCase());
    }
    ...
    checkForResults() {
        ...
        if (hidden.length === this.containers.length)
            this.noResults = true;
        else {
            if (this.noResults)
                this.noResults = false;
    ...
    render() {
        let noresults = this.noResults ? (h("span", { class: "noresults" }, "Nope, can't seem to find what you're looking for...")) : '';
        return ([
            h("flex-container", { alignx: "center", aligny: "center", fillContainer: true }, h("input", { class: "kclsu_search", placeholder: this.placeholdertext, type: "text", onInput: e => this.inputHandler(e) })),
            noresults,
            h("slot", null)
        ]);
    }
...
KclsuSearch.style = kclsuSearchCss;

export { KclsuSearch as kclsu_search };

...
const labelCardCss = globalstylesCss + ".card{height:100%;display:flex;background:#fff;position:relative;-webkit-box-shadow:0.5px 3px 5px 0px rgba(0,0,0,0.15);-moz-box-shadow:.5px 3px 5px 0px rgba(0,0,0,0.15);box-shadow:0.5px 3px 5px 0px rgba(0,0,0,0.15);border:1px solid #eaeaea;min-height:90px}.image{justify-self:flex-start;min-width:40%;height:auto}.title{margin:15px 0 0 0;line-height:22px;font-family:bree_serifbold;font-weight:500;line-height:1.1;color:#502669;padding:0 20px;display:inline-block;font-weight:bold;font-family:bree-serif, serif;font-weight:600;margin-bottom:15px}.content{display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;width:100%;padding:0 0.5em}a{display:table;padding:0 15px;margin:15px 20px 10px;color:white;background:#14847e;border-radius:30px;font-size:14px}.content p{font-size:16px;line-height:25px}@media only screen and (max-width: 500px){.image{justify-self:flex-start;min-width:30%;height:auto}.content p{font-family:\"Open Sans\", Arial, sans-serif;font-size:16px;line-height:32px;max-width:95%;text-align:center}a{margin:1em 0}}@media only screen and (max-width: 350px){.title{font-size:16px}a{margin:0}}";

const LabelCard = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.buttontitle = 'Find out more';
        this.text = '';
        this.image = 'https://res.cloudinary.com/kclsu-media/image/upload/c_fill,f_auto,fl_any_format,h_90,q_93,w_90/v1573644938/website_uploads/KCLSU%20Brand/db75df131542437eb3da2415c7f91fc6_hhoknp.jpg';
    }
    render() {
        let text = this.highlightText ? h("p", null, h("em", null, this.text)) : h("p", null, this.text);
        let content = !this.buttonlink ? text : h("kclsu-button", { verysmall: true, rounded: true, link: this.buttonlink }, this.buttontitle);
        let style = {
        ...
        return (h("div", { class: "card", style: cardStyle }, h("div", { class: "image", style: style }), h("div", { class: "content" }, h("span", { class: "title", style: headingStyle }, this.cardtitle), content)));
    }
};
LabelCard.style = labelCardCss;

export { LabelCard as label_card };

...
const gridLandingItemCss = globalstylesCss + ".item{background-color:white;position:relative;width:100%;height:100%}h3{margin:0;padding-left:1em}p{padding:1em;font-size:16px;line-height:25px}.wide{grid-column:span 2}.v-wide{grid-column:span 3}.tall{grid-row:span 2}.v-tall{grid-row:span 3}.tilelabel{position:absolute;top:0;left:0;background-color:#e22219;color:white;padding:0.5em;z-index:100;-webkit-box-shadow:rgba(0, 0, 0, 0.15) 4px 5px 4px 1px;-moz-box-shadow:.5px 3px 5px 0px rgba(0,0,0,0.15);box-shadow:rgba(0, 0, 0, 0.15) 4px 5px 4px 1px}.tilelabel a{color:white}@media only screen and (min-width: 500px) and (max-width: 780px){.item{background-color:white;position:relative;span:1;grid-column:span 2}}@media only screen and (max-width: 500px){.wide{grid-column:span 2}.v-wide{grid-column:span 2}.image{grid-column:span 1}}";

const GridLandingItem = class {
    constructor(hostRef) {
    ...
    render() {
        ...
        return ([h("h3", { class: "tilelabel" }, this.label),
            h("slot", null)]);
    }
};
GridLandingItem.style = gridLandingItemCss;

export { GridLandingItem as grid_landing_item };

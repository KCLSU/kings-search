...
const fullBioCss = globalstylesCss + "div{padding:1em}h3{color:#502669}.twitter,.facebook,.instagram{color:#15847F}";
...
const FullBio = class {
    ...
    render() {
        let facebook = !this.data.facebook ? '' : h("kclsu-button", { small: true, green: true, link: this.data.facebook }, "Facebook");
        let instagram = !this.data.instagram ? '' : h("kclsu-button", { small: true, link: this.data.instagram }, "Instagram");
        let twitter = !this.data.twitter ? '' : h("kclsu-button", { small: true, green: true, link: this.data.twitter }, "Facebook");
        let website = !this.data.website ? '' : h("kclsu-button", { small: true, green: true, link: this.data.website }, "Website");
        return (h("div", null, h("h3", null, this.data.name), h("p", null, this.data.description), h("flex-container", { alignx: "center", wrap: true }, facebook, twitter, instagram, website)));
    }
};
FullBio.style = fullBioCss;

export { FullBio as full_bio };

...
const kclsuButtonCss = globalstylesCss + ":host{margin:1em}a{box-sizing:border-box;border:1px solid #14847e;font-family:\"Open Sans\", Arial, sans-serif;line-height:32px;font-weight:700;text-transform:uppercase;border-radius:3px;cursor:pointer;position:relative;font-size:14px;-webkit-box-shadow:4px 3px 9px -2px rgba(0, 0, 0, .3);-moz-box-shadow:4px 3px 9px -2px rgba(0, 0, 0, .3);box-shadow:4px 3px 9px -2px rgba(0, 0, 0, .3);transition-duration:1s;font-size:14px;margin:15px;padding:10px 30px}.purple{border:1px solid #502865;background-color:white;color:#502865}.purple:hover{border:1px solid #502865;background-color:#502865;color:white}.green{color:white;background:#14847e;border:1px solid #14847e}.green:hover{color:#14847e;background:white;border:1px solid #14847e}.small{font-size:14px;padding:5px 18px}.verysmall{font-size:12px;padding:0px 10px;margin:0!important}.rounded{border-radius:30px}@media only screen and (max-width: 780px){.verysmall{font-size:12px;padding:0px 10px;margin:5px auto!important}}@media only screen and (max-width: 480px){:host{width:100%;text-align:center;margin:0.5em;margin-bottom:0}a{width:100%}}";

const KclsuButton = class {
    constructor(hostRef) {
    ...
    render() {
        ...
        if (this.small)
            classes.push('small');
        else if (this.verysmall)
            classes.push('verysmall');
        else
            classes.push('big');
        let link;
        if (this.link) {
            link = h("a", { href: this.link, target: this.newtab ? "_blank" : "_self", class: classes.join(' ') }, this.text, h("slot", null));
        }
        else
            link = h("a", { onClick: (e) => this.clickHandler(e), class: classes.join(' ') }, this.text, h("slot", null));
        return (h("flex-container", { alignx: this.center ? 'center' : 'flex-start', fillContainer: true }, link));
    }
};
KclsuButton.style = kclsuButtonCss;

export { KclsuButton as kclsu_button };

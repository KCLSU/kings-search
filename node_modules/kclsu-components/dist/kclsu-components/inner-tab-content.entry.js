...
const tabContentCss = globalstylesCss + ".tab-content{display:none;background:#f1f1ee;padding:40px 30px}.tab-content-active{display:block}@media screen and (max-width: 780px){.tab-content{padding:20px 15px}}";

const InnerTabContent = class {
    constructor(hostRef) {
    ...
    render() {
        ...
        return (h("section", { class: classes, hidden: this.isSelected, role: "tabpanel", "aria-labelledby": this.name }, h("slot", null)));
    }
...
InnerTabContent.style = tabContentCss;

export { InnerTabContent as inner_tab_content };

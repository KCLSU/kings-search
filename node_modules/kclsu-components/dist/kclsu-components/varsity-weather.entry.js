...
const varsityWeatherCss = globalstylesCss + ".info{align-self:flex-end;margin:0 0 2em 1em}span{display:block;font-size:16px}.icon{width:40%;height:auto}.icon img{width:100%;height:auto}";

const VarsityWeather = class {
    constructor(hostRef) {
    ...
    render() {
        if (this.weather) {
            return (h("flex-container", { aligny: "center", alignx: "space-between", fillContainer: true }, h("div", { class: "info" }, h("span", null, h("em", null, "What to expect:"), " ", this.weather.description), h("span", null, h("em", null, "Temp:"), " ", this.weather.temperature), h("span", null, h("em", null, "Cloud %:"), " ", this.weather.clouds)), h("div", { class: "icon" }, h("img", { src: this.icon, alt: this.weather.main }))));
        }
        else
            return (h("flex-container", { aligny: "center", alignx: "space-between", fillContainer: true }, h("div", { class: "info" }, h("span", null, h("em", null, "What to expect:"), " broken clouds"), h("span", null, h("em", null, "Temp:"), " 283.26"), h("span", null, h("em", null, "Cloud %:"), " 75")), h("div", { class: "icon" }, h("img", { src: "http://openweathermap.org/img/wn/04d@2x.png", alt: "Clouds" }))));
    }
};
VarsityWeather.style = varsityWeatherCss;

export { VarsityWeather as varsity_weather };

...
const GridLanding = class {
    ...
    renderItems() {
        ...
        for (let x = 0; x < this.griditems.length; x++) {
            ...
            let el = h("div", { class: classes.join(' ') }, h("slot", { name: item.label }, item));
            items.push(el);
        }
        return items;
    }
    render() {
        ...
        return (h("div", { class: "grid" }, items));
    }
    get host() { return getElement(this); }
};
GridLanding.style = gridLandingCss;

export { GridLanding as grid_landing };

...
const innerTabsContainerCss = globalstylesCss + ".kclsu-tab-headers{display:flex;flex-wrap:wrap;justify-content:center;list-style:none;}.kclsu-tab-headers{padding:0px}@media (max-width: 599px){.kclsu-tab-headers{justify-content:space-around}}";

const InnerTabsContainer = class {
    constructor(hostRef) {
...
InnerTabsContainer.style = innerTabsContainerCss;

export { InnerTabsContainer as inner_tabs_container };

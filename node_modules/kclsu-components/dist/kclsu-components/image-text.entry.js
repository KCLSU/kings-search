...
const imageTextCss = globalstylesCss + ".image-text{display:flex;justify-content:center}.info{padding:30px;width:50%}.image{width:50%}.image img{width:100%;height:auto;object-fit:cover}@media only screen and (max-width: 600px){.image-text{flex-direction:column!important;width:100%}.info{width:auto}.image{justify-content:center;width:80%;margin:auto}}";

const ImageText = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
    }
    render() {
        let info = this.text ? h("p", null, this.text) : '';
        let style = !this.switch ? {} : { "flex-direction": "row-reverse" };
        return (h("div", { class: "image-text", style: style }, h("div", { class: "info" }, h("h4", null, this.heading), info, h("slot", null)), h("div", { class: "image" }, h("img", { src: this.image }))));
    }
};
ImageText.style = imageTextCss;

export { ImageText as image_text };

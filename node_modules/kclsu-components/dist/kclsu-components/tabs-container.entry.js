...
const tabsContainerCss = globalstylesCss + ".kclsu-tabs{margin:4em}.kclsu-tab-headers{display:flex;justify-content:center;align-items:center;flex-wrap:wrap;margin:0;background-color:#e8e8e2;box-sizing:border-box}.kclsu-tab-headers{padding:20px}@media only screen and (max-width: 780px){.kclsu-tabs{margin:0.5em}.kclsu-tab-headers{padding:10px}}";

const TabsContainer = class {
    constructor(hostRef) {
    ...
    render() {
        return (h("div", { role: "presentation", class: "kclsu-tabs" }, h("ul", { role: "tablist", class: "kclsu-tab-headers" }, h("slot", { name: "tab-headers" })), h("div", { role: "presentation", class: "kclsu-tab-content" }, h("slot", { name: "tab-content" }))));
    }
    onSelectedTab(event) {
        this.selectGroup(event.detail, null);
    }
    onSelectedTabByIndex(event) {
...
TabsContainer.style = tabsContainerCss;

export { TabsContainer as tabs_container };
